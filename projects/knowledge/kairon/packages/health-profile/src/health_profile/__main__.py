...
_DISPATCH = {
    ...
    "search": lambda args: do_default({"action": "schema", **args}),
    "ingest": lambda args: do_default({"action": "schema", **args}),
    "validate": lambda args: do_default({"action": "schema", **args}),
    "register": lambda args: do_default({"action": "schema", **args}),
    "list": lambda args: do_default({"action": "schema", **args}),
    "run": lambda args: do_default({"action": "schema", **args}),
    "get": lambda args: do_default({"action": "schema", **args}),
