...
_DISPATCH = {
    ...
    "search": lambda args: do_default({"action": "sources", **args}),
    "ingest": lambda args: do_default({"action": "sources", **args}),
    "validate": lambda args: do_default({"action": "quality_gate", **args}),
    "register": lambda args: do_default({"action": "sources", **args}),
    "list": lambda args: do_default({"action": "list_components", **args}),
    "run": lambda args: do_default({"action": "quality_gate", **args}),
    "get": lambda args: do_default({"action": "sources", **args}),
    "sync": lambda args: do_default({"action": "sources", **args}),
}
