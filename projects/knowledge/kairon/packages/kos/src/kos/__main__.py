...
"""
# Dynamic class dispatch via inspect (hasattr on objects of unknown type).
...
_DISPATCH = {
    ...
    "ingest": lambda args: do_default({"action": "list_documents", **args}),
    "validate": lambda args: do_default({"action": "stats", **args}),
    "register": lambda args: do_default({"action": "list_documents", **args}),
    "list": lambda args: do_default({"action": "list_documents", **args}),
    "run": lambda args: do_default({"action": "stats", **args}),
    "get": lambda args: do_default({"action": "stats", **args}),
    "sync": lambda args: do_default({"action": "stats", **args}),
}
