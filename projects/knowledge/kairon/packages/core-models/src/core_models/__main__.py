...
_DISPATCH = {
    ...
    "search": lambda args: do_default({"action": "types", **args}),
    "ingest": lambda args: do_default({"action": "types", **args}),
    "validate": lambda args: do_default({"action": "schema", **args}),
    "register": lambda args: do_default({"action": "types", **args}),
    "list": lambda args: do_default({"action": "types", **args}),
    "run": lambda args: do_default({"action": "types", **args}),
    "get": lambda args: do_default({"action": "schema", **args}),
    "sync": lambda args: do_default({"action": "types", **args}),
}
