...
_ACTION_MAP = {
    "iris": {
        "search": "list_connectors",
        "ingest": "list_connectors",
        "validate": "config",
        "register": "commands",
...
_DISPATCH = {
    ...
    "search": lambda args: do_default({"action": "list_connectors", **args}),
    "ingest": lambda args: do_default({"action": "list_connectors", **args}),
    "validate": lambda args: do_default({"action": "config", **args}),
    "register": lambda args: do_default({"action": "commands", **args}),
    "list": lambda args: do_default({"action": "list_connectors", **args}),
    "run": lambda args: do_default({"action": "config", **args}),
    "get": lambda args: do_default({"action": "commands", **args}),
    "sync": lambda args: do_default({"action": "commands", **args}),
}
...
try:
    from .do_default import do_default as _pkg_fn
