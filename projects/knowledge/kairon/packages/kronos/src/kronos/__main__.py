...
_DISPATCH = {
    ...
    "search": lambda args: do_default({"action": "list_methods", **args}),
    "ingest": lambda args: do_default({"action": "list_methods", **args}),
    "validate": lambda args: do_default({"action": "plan", **args}),
    "register": lambda args: do_default({"action": "list_methods", **args}),
    "list": lambda args: do_default({"action": "list_methods", **args}),
    "run": lambda args: do_default({"action": "plan", **args}),
    "get": lambda args: do_default({"action": "version", **args}),
    "sync": lambda args: do_default({"action": "list_methods", **args}),
}
...
def serve() -> int:
    ...
    result: int = run_stdio_dispatch(_call_action, daemon_mode=True, restart_delay_sec=60)
    return result
