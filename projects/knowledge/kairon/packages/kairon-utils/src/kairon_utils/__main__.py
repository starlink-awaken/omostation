...
_DISPATCH = {
    ...
    "ingest": lambda args: do_default({"action": "retry", **args}),
    "validate": lambda args: do_default({"action": "list_components", **args}),
    "register": lambda args: do_default({"action": "logger", **args}),
    "list": lambda args: do_default({"action": "list_components", **args}),
    "run": lambda args: do_default({"action": "retry", **args}),
    "get": lambda args: do_default({"action": "list_components", **args}),
    "sync": lambda args: do_default({"action": "retry", **args}),
}
