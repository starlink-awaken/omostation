...
_DISPATCH = {
    ...
    "search": lambda args: do_default({"action": "list_components", **args}),
    "ingest": lambda args: do_default({"action": "alert", **args}),
    "validate": lambda args: do_default({"action": "list_components", **args}),
    "register": lambda args: do_default({"action": "list_components", **args}),
    "list": lambda args: do_default({"action": "list_components", **args}),
    "run": lambda args: do_default({"action": "metric", **args}),
    "get": lambda args: do_default({"action": "metric", **args}),
    "sync": lambda args: do_default({"action": "metric", **args}),
}
