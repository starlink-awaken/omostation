...
_DISPATCH = {
    ...
    "search": lambda args: do_default({"action": "compile", **args}),
    "ingest": lambda args: do_default({"action": "transitions", **args}),
    "validate": lambda args: do_default({"action": "compile", **args}),
    "register": lambda args: do_default({"action": "list_components", **args}),
    "list": lambda args: do_default({"action": "list_components", **args}),
    "run": lambda args: do_default({"action": "compile", **args}),
    "get": lambda args: do_default({"action": "list_components", **args}),
    "sync": lambda args: do_default({"action": "transitions", **args}),
}
