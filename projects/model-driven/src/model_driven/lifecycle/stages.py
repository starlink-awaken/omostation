...
from model_driven.mof.m3_extended import LifecycleStage, STANDARD_GATES, STANDARD_STAGES, Stage, Gate
...
class LifecycleTracker:
    ...
    def get_progress(self) -> dict[str, Any]:
        ...
        completed = sum(
            1 for s in LifecycleStage
            if self.stages[s].status == StageStatus.COMPLETED
        )
        return {
            "entity_id": self.entity_id,
