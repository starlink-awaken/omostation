...
omostation/
├── projects/
│   ├── kairon/          ← Python monorepo, 33 包
│   ├── SharedBrain/     ← 数字化生命 OS（文档参考，源码已归档）
...
- `.omo/state/system.yaml` — 当前运行状态源
- `.omo/STATE.md` — 架构历史与演进里程碑（legacy snapshot）
- `.omo/INVENTORY.md` — 全系统资产清单
- `.omo/standards/README.md` — standards 注册表
- `AGENTS.md` — 项目治理边界
- `README.md` — 项目总览
