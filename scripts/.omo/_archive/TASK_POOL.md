...
> 状态: legacy mirror
> 最后更新: 2026-05-30
> 说明: 本文件保留 Phase 6X 历史任务，不再作为 Agent 认领入口。当前任务 SSOT 已迁移到 `.omo/tasks/{active,done,blocked}/*.yaml`。

当前执行入口：

- 目标源: `.omo/goals/current.yaml`
- 任务源: `.omo/tasks/active/*.yaml`
- 状态源: `.omo/state/system.yaml`
