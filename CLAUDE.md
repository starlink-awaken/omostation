...
3. Use `rg` for text discovery; for callers/impact prefer codebase-memory MCP (see [`docs/operations/memory-os-epic-retro.md`](docs/operations/memory-os-epic-retro.md)).
...
| Code callers / impact | [`docs/operations/memory-os-epic-retro.md`](docs/operations/memory-os-epic-retro.md) |
