...
SPEC = importlib.util.spec_from_file_location("generate_brief", str(WORKSPACE / "bin" / "mof" / "generate-brief.py"))
...
def test_write_brief_if_changed_skips_when_only_generated_stamp_differs(tmp_path, monkeypatch):
    ...
    changed = generate_brief.write_brief_if_changed("> **Generated**: 2026-99-99T99:99:99Z\n\nbody")
