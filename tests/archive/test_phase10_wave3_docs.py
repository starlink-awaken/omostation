...
def test_phase10_wave3_is_recorded_as_history_after_phase10_completion() -> None:
    ...
    done_wave3_task = _read("tasks/done/P10-W3-ACTION-FIRST-MATRIX.yaml")
    ...
    assert ".omo/plans/phase10-wave3-execution-plan.md" in done_wave3_task
