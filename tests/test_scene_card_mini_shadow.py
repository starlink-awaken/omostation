...
# ---------------------------------------------------------------------------
# File I/O — non-destructive editing
# ---------------------------------------------------------------------------


def test_record_appends_without_overwriting_existing_lifecycle_gate(tool, tmp_path: Path):
    """Recording must preserve target/blocking_bet/thresholds/measured_*/status/rationale."""
    # Create a minimal scene card.
...
"""
    ...
    # Monkey-patch SCENES_DIR to use tmp_path.
    ...
    # New mini_trial block must be appended
...
# ---------------------------------------------------------------------------
# CLI smoke test (subprocess against a real shadow card fixture)
# ---------------------------------------------------------------------------


def test_cli_list_succeeds_against_real_workspace():
    """Smoke test: --list works on the actual docs/scene-cards/ dir."""
    ...
    # We have 8 shadow cards per the audit
