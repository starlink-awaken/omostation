...
def test_build_review_queue_splits_due_upcoming_unscheduled_and_escalation_sections(
    tmp_path: Path,
) -> None:
    ...
    queue = build_review_queue(
        (
            _item(
                ...
                severity="critical",
                gate_level="gate",
                next_review_at="2026-06-05T00:00:00Z",
            ...
            _item(
                "STALE_DUE",
                severity="medium",
                next_review_at="2026-06-06T00:00:00Z",
                mitigation_refs=(),
            ),
        ),
