...
CONTRACT_DOC="$ROOT/.omo/standards/pipeline-json-v1.1.md"
...
checks = [
    ...
    ("JSON Schema 定义", "$id" in content),
    ("pipeline tool/action/timestamp", "tool" in content and "action" in content and "timestamp" in content),
