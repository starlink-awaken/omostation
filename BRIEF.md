...
> **Generated**: `2026-07-29T02:45:30.024171Z` | **SSOT Source**: `.omo/state/system.yaml::health_score` | **ISC-3 复合分**: `88/100`
...
- 场景总数: `161` | 通过率: `98.1%`
- 对抗集: `57` 个, 失败率 `5%` (P84: 全过=对抗不足须加强)
- 冲突消解成功率: `98%` | 平均协商轮次: `0.65`

### 📦 产能轨 (Throughput · 真实 backlog, 不可造)
> 数据源: `真实 backlog (.omo/tasks/done+planned/, 不可造)`

- 真实任务: `59` done / `2` planned (完成率 `96.7%`)
- 人工直做占比: `0%` (0/59)
- **静默丢失: `0`** ✅ 硬红线达成
