...
Agora is the eCOS v6 BOS URI routing and MCP Hub. See [`../README.md`](../README.md) for a quick overview and [`../CAPABILITY-MAP.md`](../CAPABILITY-MAP.md) for capabilities.
