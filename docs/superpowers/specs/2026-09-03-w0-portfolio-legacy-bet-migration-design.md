...
Principal session authorization 2026-09-04 (safer Wave order: self-binding → T1-07 → T1-06) authorizes this child's manifest-only implementation. `--apply` remains unauthorized.
