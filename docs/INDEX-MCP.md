...
| 服务器 | 层 | 工具数 | 传输 | 端口 | 源文件 |
|--------|-----|--------|------|------|--------|
| `agora` | I0 | 113 | stdio/sse | — | `projects/agora/src/agora/server/mcp.py` |
