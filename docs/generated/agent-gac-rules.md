...
<!-- Run: python3 bin/gac-export-agents.py to regenerate. Source: governance-checks.yaml (184 rules) -->
...
| `CR-CROSS-REPO-CHECK` | meta | consistency_drift | bin/check-cross-repo-consistency.py unregistered ≤ threshold (默认 0, Phase 3 治本后).
