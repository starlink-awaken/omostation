  ...
  "drills": [
    {
      ...
      "passed": true,
      "detail": "Intercepted 4/4 illegal script/dependency writes"
    },
    {
    ...
    },
    {
      ...
      "passed": true,
      "detail": "Health budget violation blocked: True, Transfer reward violation blocked: True"
    },
    {
    ...
    },
    {
      ...
      "passed": true,
      "detail": "Link disconnect simulated; mesh avoided disconnected peer: True"
    },
    {
      "drill_name": "Dirty Worktree Exploit & Detection",
      "category": "Worktree Hygiene",
      "passed": true,
      "detail": "git status --porcelain detected fake-dirty.txt: True"
    },
    {
      "drill_name": "Zombie Lock Injection & Stale Cleanup",
      "category": "Concurrency Lock",
      "passed": true,
      "detail": "stale lock injected (expires_at=past): detected"
    },
    {
      "drill_name": "Submodule Pointer Drift & Sync Recovery",
      "category": "Submodule Integrity",
      "passed": true,
      "detail": "submodule SHA drift detected: True (output snippet: +65cb8c0dcb364973e12a383e1047b4ffa36821e0 sub (remotes/origin/HEAD))"
    },
    {
      "drill_name": "Harness Admission Bypass Attempt",
      "category": "Harness Lifecycle",
      "passed": true,
      "detail": "injected harness_polluted.py detected as admission-blocker: True"
    },
    {
      "drill_name": "Mass Deletion Guard & Recovery",
      "category": "Git Safety",
      "passed": true,
      "detail": "detected 49 deleted files (threshold 30): guard triggered"
    }
  ]
}
