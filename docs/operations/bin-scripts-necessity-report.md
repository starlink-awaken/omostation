...
| gen_capability_registry              | governance | managed | bin-master, scripts-compat-shim | -   | bin/cockpit/gen-capability-registry.py           | scripts/bin/cockpit/gen-capability-registry.py           |
| gen_help_docs                        | governance | managed | bin-master, scripts-compat-shim | -   | bin/cockpit/gen-help-docs.py                     | scripts/bin/cockpit/gen-help-docs.py                     |
