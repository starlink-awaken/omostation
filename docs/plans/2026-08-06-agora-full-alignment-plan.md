...
| # | 项 | 文件 | 现状 | 动作 |
|---|---|---|---|---|
| 1 | 子模块指针 | 主仓 projects/agora | d128c5f (P2) | **bump → 7756362** (复盘修复) |
...
| 5 | cockpit 硬编码 | projects/cockpit/src/cockpit/commands/bos.py:672 | 7422 | 改 port-registry SSOT |
| 6 | scene-card | docs/scene-cards/ | 不覆盖 agora | 补 agora 网关场景卡 |
| 7 | CI submodules | .github/workflows/agora-ci.yml | recursive+continue-on-error | 对齐 PR #906 (submodules:false) |
