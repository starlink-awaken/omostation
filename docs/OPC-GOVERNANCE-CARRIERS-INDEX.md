...
|:------|:-----|:--------------|:----------|:----------------|:------------|
| **P3** Swarm Execution Spine | Gate D | [OPC-P3-SWARM-SPINE.yaml](../.omo/tasks/planned/OPC-P3-SWARM-SPINE.yaml) | [OPC-PHASE3-SWARM-SPINE.md](OPC-PHASE3-SWARM-SPINE.md) | [OPC-P3-GATE-D-OPENING.yaml](../.omo/tasks/registry/done/OPC-P3-GATE-D-OPENING.yaml) | ⏳ not_yet_passed (D1+D2 ✅, D3-D5 📋) |
| **P4** Model & Compute Plane | Gate E | [OPC-P4-MODEL-COMPUTE.yaml](../.omo/tasks/planned/OPC-P4-MODEL-COMPUTE.yaml) | [OPC-PHASE4-MODEL-COMPUTE.md](OPC-PHASE4-MODEL-COMPUTE.md) | — (E1-E4 全部 📋) | ⏳ not_yet_passed |
| **P5** North Star Scenarios | Gate F | [OPC-P5-SCENARIOS.yaml](../.omo/tasks/planned/OPC-P5-SCENARIOS.yaml) | [OPC-PHASE5-SCENARIOS.md](OPC-PHASE5-SCENARIOS.md) | — (F1-F4 全部 📋) | ⏳ not_yet_passed |
| **P6** Self-Evolution Loop | Gate G | [OPC-P6-EVOLUTION-LOOP.yaml](../.omo/tasks/planned/OPC-P6-EVOLUTION-LOOP.yaml) | [OPC-PHASE6-EVOLUTION-LOOP.md](OPC-PHASE6-EVOLUTION-LOOP.md) | — (G1-G4 全部 📋) | ⏳ not_yet_passed |
| **P7** Governance Hardening | Gate H (= 最终 gate) | [OPC-P7-RELEASE-TRAIN.yaml](../.omo/tasks/planned/OPC-P7-RELEASE-TRAIN.yaml) | [OPC-PHASE7-RELEASE-TRAIN.md](OPC-PHASE7-RELEASE-TRAIN.md) | — (H1-H5 全部 📋) | ⏳ not_yet_passed |
...
- 当前 sub-gate: **G1-G4 全部 📋 not_started**
...
- 当前 sub-gate: **H1-H5 全部 📋 not_started**
...
P3 (Gate D) ── prereq ─→ P4 (Gate E) ── prereq ─→ P5 (Gate F) ─→ P6 (Gate G) ─→ P7 (Gate H)
   │                            │                    │                  │              │
   └── D1+D2 done               └── E1-E4 待跑      └── F1-F4 待跑     └── G1-G4 待跑  └── H1-H5 待跑
       (thin binding)               (LLM 路由)         (3 scenarios)     (loop 闭环)     (release train)
```

- P3 当前可开 (D1+D2 passed)
- P4 治理载体就位, **业务实施 blocked** until P3 Gate D passed
- P5-P7 治理载体就位, 业务实施 blocked until 前序 gate 收口
...
- ✅ 治理载体总数 = **8** (5 yaml + 4 doc + 1 GATE-D-OPENING + 1 INDEX)
- ✅ `scripts/lint-opc-carriers.py` 退出码 0

**未做** (留 R57+):
- P3 D3-D5 业务实施
- P4-P7 业务实施
- 任何 sub-gate 的 runtime 实证
