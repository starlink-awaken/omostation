...
| doc-governance-check.py | 文档 ownership/lifecycle/freshness/discoverability；区分元数据迁移与内容复审 | `python3 bin/ssot/doc-governance-check.py` (`--no-new-warnings` 阻断新增 warning，`--strict` 阻断全部 warning) |
