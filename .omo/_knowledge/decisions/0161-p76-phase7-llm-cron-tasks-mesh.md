...
- ✅ 实际实现 = `bin/_archive/2026-08-conv3/gac-mesh-router.py` (HTTP server, port 7437)
- ✅ port 在 `protocols/port-registry.yaml::7437` (`omlx-mesh-router`)

**决议**: 
- 修改 `docs/project-registry.yaml` 加 `status: implemented-in-bin` + `physical_location: bin/_archive/2026-08-conv3/gac-mesh-router.py`
