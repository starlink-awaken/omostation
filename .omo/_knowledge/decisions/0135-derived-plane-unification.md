...
把 ADR-0129 派生面投影面范式 落地为可执行纪律:`bin/_archive/2026-08-conv3/omo-state-cleanup.py`
...
- bin/_archive/2026-08-conv3/omo-state-cleanup.py 3 命令:audit / status / canonify
...
```
SSOT = bin/_archive/2026-08-conv3/omo-state-cleanup.py::DERIVED_PATHS
...
| 检查 | 工具 | 结果 |
|------|------|------|
| 33 DERIVED_PATHS 审计 | `bin/_archive/2026-08-conv3/omo-state-cleanup.py audit` | 27 PASS, 5 误报路径(子模块/submodule 内) |
