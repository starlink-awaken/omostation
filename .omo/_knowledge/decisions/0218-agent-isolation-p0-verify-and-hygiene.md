...
> **背景**: 本 ADR 是 ADR-0210 收敛期 P0「启用 Agent Isolation」的落地承载。编号 0218（#402 原占 0214 撞 P74 silent，重号）（撞号规则见 ADR-0202 D4）。
...
*ADR-0218 · PROPOSED · 2026-07-15 · 夏明星 · ADR-0210 收敛期 P0 落地承载*

## G-CONV.1 Confirmation (ISC-4) — 2026-07-17

`gh api repos/starlink-awaken/omostation/branches/main/protection` → **HTTP 200**.

- `required_pull_request_reviews` present (`required_approving_review_count: 0`)
- `enforce_admins.enabled: true`
- `required_status_checks.contexts: [gac-gate, ruff]`
- `allow_force_pushes.enabled: false`

**Verdict**: ISC-4 branch protection **active**. Isolation P0 API gate satisfied.
