...
### D3. B1 — `bin/_archive/gate-effectiveness.py`
...
# B1
python3 bin/_archive/gate-effectiveness.py         # top 5 + bottom 5 table
python3 bin/_archive/gate-effectiveness.py --json | jq '.gates | length'
