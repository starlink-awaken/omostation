...
### 决策 1: 新增 `bin/gac/gate-roi-report.py`
...
```bash
python3 bin/gac/gate-roi-report.py             # 表格 + 减法建议
python3 bin/gac/gate-roi-report.py --json      # 结构化 (仪表盘可消费)
python3 bin/gac/gate-roi-report.py --markdown  # 季度报告文本
```
