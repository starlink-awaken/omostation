...
| **Foundry v2: port-governance deck** | ✅ | `bin/_archive/quota-clearance-2026-08-24/port-governance-deck.py` (4 checks + catalog metrics) |
...
- `bin/_archive/start-gateway.sh`: 1234 (LM Studio LEGACY, 豁免) + 9290 (已迁移 → `LLM_GATEWAY_PORT`)
- `bin/_archive/2026-08-conv3/gac-mesh-router.py`: 7437 (已迁移 → `OMLX_MESH_ROUTER_PORT`)
- 其他 bin/ 文件无未注册端口
- config/ 目录不存在 (未使用)
...
新增第 10 deck: `bin/_archive/quota-clearance-2026-08-24/port-governance-deck.py`
