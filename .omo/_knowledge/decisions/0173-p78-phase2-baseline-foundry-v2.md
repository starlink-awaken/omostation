...
| **Foundry v2: port-governance deck** | ✅ | `bin/_archive/2026-08-conv3/port-governance-deck.py` (4 checks + catalog metrics) |
...
- `bin/_archive/2026-08-t6-05/start-gateway.sh`: 1234 (LM Studio LEGACY, 豁免) + 9290 (已迁移 → `LLM_GATEWAY_PORT`)
...
新增第 10 deck: `bin/_archive/2026-08-conv3/port-governance-deck.py`
