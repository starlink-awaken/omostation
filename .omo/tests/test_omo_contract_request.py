...
def test_contract_request_ref_uses_task_id_and_timestamp_slug():
    from scripts.omo_contract_request import contract_request_ref
...
def test_build_contract_request_creates_structured_artifact_with_deliverables():
    from scripts.omo_contract_request import build_contract_request, contract_request_ref
...
def test_build_contract_proposal_targets_task_yaml_and_sets_deliverables():
    from scripts.omo_contract_request import build_contract_proposal, contract_request_ref
