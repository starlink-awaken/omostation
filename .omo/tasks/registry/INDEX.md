...
| needs-human-run-abe091ce-dormant | run abe091ce 静默卡死 (active 无产出 + observe halt 不能 | candidate |
...
---
*Updated: 2026-07-25 (依据 `omo state sync-tasks` 与真实目录重算: done=0, planned=12, active=0, archived=6 顶层)*
