...
| BET-Y1Q4-T16-ops-drift-guard | ops 注册表防漂移双闸 — check-signals drift 检测 + cron 准入校 | candidate |
...
## Completed Tasks (296 个)

> `tasks/done/` — 296 个顶层 YAML 文件，子目录按 Phase/主题分组存放历史任务。
...
---
*Updated: 2026-09-18 (依据 `omo state sync-tasks` 与真实目录重算: done=296, planned=12, active=1, blocked=1, archived=6 顶层)*
