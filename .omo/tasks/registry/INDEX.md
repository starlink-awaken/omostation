...
## Completed Tasks (290 个)

> `tasks/done/` — 290 个顶层 YAML 文件，子目录按 Phase/主题分组存放历史任务。
...
---
*Updated: 2026-08-29 (依据 `omo state sync-tasks` 与真实目录重算: done=290, planned=6, active=1, blocked=1, archived=6 顶层)*
