...
| submodule-dirty-cleanup | 子模块 dirty 清理: omo/l4-kernel/runtime 内未提交改动需 comm | candidate |

> **补充规划**: `.omo/tasks/planned/vision-roadmap/` 子目录保留长期愿景路线图（4 YAML + 5 MD），不纳入标准 planned 任务计数。

## Completed Tasks (103 个)

> `tasks/done/` — 103 个顶层 YAML 文件，子目录按 Phase/主题分组存放历史任务。
...
---
*Updated: 2026-07-23 (依据 `omo state sync-tasks` 与真实目录重算: done=103, planned=2, active=0, archived=6 顶层)*
