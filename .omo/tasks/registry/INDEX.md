...
## Completed Tasks (120 个)

> `tasks/done/` — 120 个顶层 YAML 文件，子目录按 Phase/主题分组存放历史任务。
...
---
*Updated: 2026-07-31 (依据 `omo state sync-tasks` 与真实目录重算: done=120, planned=2, active=0, archived=6 顶层)*
