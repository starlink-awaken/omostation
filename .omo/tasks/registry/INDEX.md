...
## Completed Tasks (300 个)

> `tasks/done/` — 300 个顶层 YAML 文件，子目录按 Phase/主题分组存放历史任务。
...
---
*Updated: 2026-09-18 (依据 `omo state sync-tasks` 与真实目录重算: done=300, planned=8, active=1, blocked=1, archived=6 顶层)*
