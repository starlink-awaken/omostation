...
## Completed Tasks (59 个)

> `tasks/done/` — 59 个顶层 YAML 文件，子目录按 Phase/主题分组存放历史任务。
...
---
*Updated: 2026-07-29 (依据 `omo state sync-tasks` 与真实目录重算: done=59, planned=2, active=0, archived=6 顶层)*
