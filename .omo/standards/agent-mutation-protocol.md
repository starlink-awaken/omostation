...
5. **REQUIREMENT ITERATION VIA WORKFLOW (ADR-0203)**: 需求迭代（功能/缺陷/运维/治理交付）必须先 `agent-workflow start` 再写；见 `agent-workflows/_root.yaml::requirement_iteration_policy` 与 `agent-workflow-contract.md` §3.1。
