...
用法:
    uv run --with pyyaml python bin/mof/m4-cron-hook.py
    uv run --with pyyaml python bin/mof/m4-cron-hook.py --sync # 写 .omo/_derived/m4-cron-log.json
    uv run --with pyyaml python bin/mof/m4-cron-hook.py --trigger cron # 受 OMO cron 调
"""
