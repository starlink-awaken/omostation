...
用法:
  python3 bin/mof/gen-project-registry.py           # 检测 drift, 有漂移返回 1
  python3 bin/mof/gen-project-registry.py --write    # 修复 registry version/python
  python3 bin/mof/gen-project-registry.py --json     # 机器可读 JSON (gac-healthcheck 消费)
