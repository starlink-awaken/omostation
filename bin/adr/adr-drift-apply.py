...
用法:
  python3 bin/adr/adr-drift-apply.py            # 应用 SUBDIR_MISSING 修复
  python3 bin/adr/adr-drift-apply.py --json     # JSON 输出
  python3 bin/adr/adr-drift-apply.py --dry-run  # 干跑 (不 touch)
"""
