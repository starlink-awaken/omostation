...
用法:
  python3 bin/check-boundary.py <package-name> [project]
  python3 bin/check-boundary.py protocols-layer kairon   # 应 fail
  python3 bin/check-boundary.py kos kairon                # 应 pass
