#!/bin/bash
# tailscale-heartbeat.sh — tailscale daemon 心跳 + 僵尸接口检测 (2026-09-01 复发病防复发)
#
# 病理 (omlxc/docs/operations/2026-08-25-retrospective.md + 2026-09-01 复发):
#   tailscaled 死后 utun0 接口与 100.64/10 路由残留 → "表象活着, 数据流死了"。
#   本心跳做产出断言: status --json 成功才算 ok; daemon 死 + 残留接口 → zombie 标注。
#
