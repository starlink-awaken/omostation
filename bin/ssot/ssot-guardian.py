...
用法:
  python3 bin/ssot/ssot-guardian.py              # 检测,有漂移返回 1
  python3 bin/ssot/ssot-guardian.py --auto-fix   # 检测并修复白名单字段
  python3 bin/ssot/ssot-guardian.py --emit       # 无论是否漂移都发事件
        ...
        issues.append(
            {
                ...
                "auto_fix": False,
                "note": "0字节文件或大小写 inode 冲突 (CR-HYG-01/02); 见 bin/gac/gac-hygiene-check.py",
            }
        )
