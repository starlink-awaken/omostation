...
用法:
  python3 bin/ssot/check-god-module.py           # 报告 (exit 0)
  python3 bin/ssot/check-god-module.py --strict  # gate (有 >1500L 则 exit 1)
  python3 bin/ssot/check-god-module.py --json    # JSON 输出 (供 dashboard)
"""
...
def main() -> int:
    ...
    parser.add_argument("--strict", action="store_true", help=f">{ERROR_THRESHOLD}L 报 error (exit 1)")
