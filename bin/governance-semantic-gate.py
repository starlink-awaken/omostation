...
def run_gate(*, release: bool = False) -> dict[str, Any]:
    ...
    definitions: list[tuple[str, list[str], Callable[[dict[str, Any]], tuple[bool, list[str]]], str, bool]] = [
        ...
        (
            "gac-mof-validate",
            _command("bin/gac-mof-validate.py", "--json"),
            _simple_ok,
            "error",
            True,
        ),
        ...
        (
            "adr-coverage",
            _command("bin/adr-coverage.py", "--json"),
            _adr_ok,
            "error",
            True,
        ),
        ...
        (
            ...
            _command("bin/governance-evolution.py", "packages", "--json"),
        ...
        (
            ...
            _command("bin/gen-service-configs.py", "--validate", "--json"),
            _simple_ok,
            "error",
            True,
        ),
