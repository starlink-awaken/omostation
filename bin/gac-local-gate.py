...
DEFAULT_POLICY = {
    ...
    "gates": [
        {"id": "gac-validate", "command": ["bin/gac-validate.py", "--gate"]},
        {"id": "gac-drift", "command": ["bin/gac-drift.py"]},
        {"id": "write-owner-audit", "command": ["bin/write-owner-audit.py", "--staged"]},
        {"id": "install-watch-agent", "command": ["bin/install-watch-agent.py"], "ci_skip": True},
        {"id": "test-mcp-kos", "command": ["bin/test-mcp-kos.py"]},
        {"id": "check-cockpit-ui-dist", "command": ["bin/check-cockpit-ui-dist.py"]},
        ...
        {"id": "governance-evolution", "command": ["bin/governance-evolution.py", "validate", "--json"]},
        ...
        {"id": "doc-link-check", "command": ["bin/doc-link-check.py"]},
        {"id": "change-lane-check", "command": ["bin/change-lane-check.py", "--staged"]},
        {"id": "dependency-baseline-drift", "command": ["bin/gen-dependency-baseline.py", "--check"], "ci_only": True},
        {"id": "matrix-consistency", "command": ["bin/matrix-consistency-lint.py", "--skip-launchd"], "ci_skip": True},
        {"id": "governance-convergence", "command": ["bin/governance-convergence-lint.py"]},
        {"id": "governance-semantic-gate", "command": ["bin/governance-semantic-gate.py", "--json"]},
        {"id": "state-freshness-check", "command": ["bin/state-freshness-check.py", "--json"]},
