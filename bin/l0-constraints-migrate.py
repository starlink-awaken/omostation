...
用法:
    uv run python3 bin/l0-constraints-migrate.py --dry-run
    uv run python3 bin/l0-constraints-migrate.py
    uv run python3 bin/l0-constraints-migrate.py --validate     # 仅校验 v2
    uv run python3 bin/l0-constraints-migrate.py --report       # 输出迁移报告
"""
