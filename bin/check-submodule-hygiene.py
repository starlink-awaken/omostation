...
用法:
    uv run --with pyyaml python bin/check-submodule-hygiene.py
    uv run --with pyyaml python bin/check-submodule-hygiene.py --json
    uv run --with pyyaml python bin/check-submodule-hygiene.py --strict   # 任何错都 exit 1
