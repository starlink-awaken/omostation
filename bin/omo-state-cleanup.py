...
用法:
    uv run --with "pyyaml" python bin/omo-state-cleanup.py audit
    uv run --with "pyyaml" python bin/omo-state-cleanup.py status
    uv run --with "pyyaml" python bin/omo-state-cleanup.py canonify
"""
...
MUST_BE_TRACKED_PATHS = [
    ...
    "bin/l0-constraints-migrate.py",  # P1-S2 工具
    "bin/mof-bootstrap.py",  # P2-S4 校验器
]
