...
# Submodule may not be initialized; handle gracefully
...
def main():
    ...
    if result['tools']['unused_count'] > 0:
        print(f"  ⚠️  {result['tools']['unused_count']} tools not in CI")
