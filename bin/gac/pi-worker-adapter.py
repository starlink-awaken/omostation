...
def _binding_contract() -> Any:
    ...
    spec = importlib.util.spec_from_file_location("_pi_worker_binding_contract", contract_path)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ack = command.add_parser("ack", help="validate and append one authenticated Mesh ACK")
