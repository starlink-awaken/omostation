#!/usr/bin/env python3
# bin/gac/gac-compute-onboard.py — eCOS v6 算力网格与大盘网络一体化并网与治理自检工具
#
# 整合五大算力通道:
...
def onboard_litellm() -> dict:
    ...
    from llm_gateway import gateway_key
    from llm_gateway import gateway_url as _gw

    gateway_url = f"{_gw()}/v1/chat/completions"
    api_key = gateway_key()
