...
def main():
    ...
    hb = sub.add_parser("heartbeat"); hb.add_argument("--agent", required=True)
    der = sub.add_parser("deregister"); der.add_argument("--agent", required=True)
    lst = sub.add_parser("list"); lst.add_argument("--json", action="store_true")
