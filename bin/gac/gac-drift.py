...
用法:
  python3 bin/gac/gac-drift.py              # drift 检测, exit 0=无 drift, 1=有 drift
  python3 bin/gac/gac-drift.py --gate       # CI gate (drift 则 fail)
  python3 bin/gac/gac-drift.py --report     # 详细
