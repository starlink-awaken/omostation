...
用法:
  python3 bin/gac/auto-merge-lane-policy.py <path1> <path2> ...   # 判定 paths
  python3 bin/gac/auto-merge-lane-policy.py --staged               # 判定 staged 文件
  python3 bin/gac/auto-merge-lane-policy.py --json <paths>         # 机器可读
