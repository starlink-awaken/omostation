...
使用:
  ...
  python3 bin/gac/governance-dashboard.py --json
  python3 bin/gac/governance-dashboard.py --tools governance-history,adr-coverage  # 子集
"""
...
<p style="color:#999">ADR-0106 · {report.get("timestamp", "")} · 生成自 bin/gac/governance-dashboard.py</p>
