...
用法:
  python3 bin/gac/gac-mof-validate.py          # M2 校验, exit 0=符合, 1=违反
  python3 bin/gac/gac-mof-validate.py --report  # 详细 (含 M2 fields)
  python3 bin/gac/gac-mof-validate.py --json    # JSON (cron/仪表盘)

CI 可移植: Path(__file__).resolve().parents[2].
"""
