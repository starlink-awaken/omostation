...
用法:
  python3 bin/gac/gac-m1-sync.py              # diff: 报告 registry vs M1 差异
  python3 bin/gac/gac-m1-sync.py --sync      # 同步: 生成缺失 + 更新过期 + 删除多余
  python3 bin/gac/gac-m1-sync.py --json      # JSON 输出 (cron/仪表盘)
"""
...
def rule_to_m1_yaml(rule: dict) -> str:
    ...
    header = (
        ...
        "# DO NOT edit manually — re-run: python3 bin/gac/gac-m1-sync.py --sync\n"
    )
