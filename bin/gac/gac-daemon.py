...
用法:
  python3 bin/gac/gac-daemon.py --start              # 启动 daemon (前台, 阻塞)
  python3 bin/gac/gac-daemon.py --write PATH CONTENT  # 经 daemon 写
  python3 bin/gac/gac-daemon.py --stop               # 停 daemon
  python3 bin/gac/gac-daemon.py --ping               # 查 daemon 活
