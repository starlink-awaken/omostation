...
LEGACY_CR_IDS = {
    ...
    "CR-AGT-ASI-10",
    "CR-CROSS-REPO",
    "CR-CROSS-REPO-REGISTRY-CONSISTENT",
    "CR-GOV-CLOSED-LOOP-01",
    "CR-GOV-COMMIT-FREQUENCY-01",
    "CR-GOV-DIMENSION-SATURATION-01",
    "CR-GOV-DOC-CATEGORY-01",
    "CR-GOV-FRONTMATTER-SCHEMA-01",
    "CR-GOV-CATEGORY-01",
    "CR-ENG-MYPY-TRUTH-01",
    "CR-ENG-SSOT-POINTER-01",
    "CR-ENG-BUG-CHAIN-01",
    "CR-ENG-CWD-ABSOLUTE-01",
    "CR-DEBT-GATE-ENUM-01",
    "CR-DEBT-CLOSURE-EVIDENCE-01",
    "CR-CROSS-PROJECT-LINT-01",
    ...
    "X4-C01",
    "X4-C02",
    "X1-OMNI-BUS-ROUTING-20260617",
    "X1-OMO-GOVERNANCE-SURFACES-20260616",
    "X1-OMO-DIRECT-MUTATION-GATE-20260617",
    "X1-ARCH-MERGE-LLMGATEWAY-20260616",
    "X1-DEBT-EVIDENCE-CLOSURE-20260620",
    "X1-CROSS-PROJECT-LINT-ENFORCE-20260620",
    "X1-AUD-COMMIT-LOOP",
    "X2-FRESH-OMO-GOVERNANCE-SURFACES",
    "X2-FRESH-EVIDENCE-ALIAS",
    "X2-FRESH-ARCHIVED-LLMGATEWAY",
    "X2-FRESH-MERGE-CHECKLIST",
    "X2-FRESH-DEBT-EVIDENCE-INTEGRITY",
    "X2-FRESH-CROSS-PROJECT-LINT",
    "X2-FRESH-MOF-VERSION-BUMP",
    "X2-FRESH-DOC-LIFECYCLE",
    "X2-FRESH-COMMIT-FATIGUE",
    "X2-FRESH-OMO-LINT-SIZE",
    "X2-FRESH-GOV-DASHBOARD",
    "X2-FRESH-ADR-DRIFT",
    "X4-CONS-OMO-GOVERNANCE-SURFACES",
    "X4-CONS-LLMGATEWAY-ARCHIVED",
    "X4-CONS-P43-CLOSED-LOOP-SSOT",
    "X4-CONS-DEBT-GITIGNORE-BOUNDARY",
    "X4-CONS-DRIFT-VS-GOVERNANCE",
    "MCP",
    "ACP",
    "A2A",
    "BOS-URI",
...
def check_rule_registration() -> tuple[list[str], list[str]]:
    ...
    unregistered = (adr_cr_ids - registered_ids) - LEGACY_CR_IDS
    if unregistered:
