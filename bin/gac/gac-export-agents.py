...
def export_full_markdown(rules):
    ...
    lines.append("<!-- AUTO-GENERATED by bin/gac/gac-export-agents.py — do not edit manually -->")
    lines.append(
        f"<!-- Run: python3 bin/gac/gac-export-agents.py to regenerate. Source: governance-checks.yaml ({len(rules)} rules) -->"
    )
    lines.append("")
...
def export_agents_pointer() -> str:
    ...
    lines.append("> Validate: `python3 bin/gac/gac-validate.py --gate` | Drift: `python3 bin/gac/gac-drift.py`")
    lines.append("> Regenerate: `python3 bin/gac/gac-export-agents.py`")
    lines.append("")
