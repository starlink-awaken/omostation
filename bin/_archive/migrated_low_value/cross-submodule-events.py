...
使用:
  python3 bin/ssot/cross-submodule-events.py --watch
  python3 bin/ssot/cross-submodule-events.py --kind governance_alert
  python3 bin/ssot/cross-submodule-events.py --stats  # 统计历史
"""
