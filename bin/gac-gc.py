...
用法:
  python3 bin/gac-gc.py              # 扫描 + 报告
  python3 bin/gac-gc.py --dry-run    # 显示 gc 候选 (不改)
  python3 bin/gac-gc.py --json       # JSON (cron/仪表盘)

CI 可移植: Path(__file__).resolve().parents[1]. 对标 gac-validate/gac-drift/gac-healthcheck.
"""
