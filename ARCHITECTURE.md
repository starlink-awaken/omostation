...
| [`docs/architecture/blueprint-multi-agent-execution-control-v1.md`](docs/architecture/blueprint-multi-agent-execution-control-v1.md) | 可分发给 Executor、Verifier、Strategic Director 和各 Agent 平台的统一操作指令 |
