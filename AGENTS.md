...
GitHub Actions workflows in `.github/workflows/` (**20 workflows**, 9/9 项目覆盖):
...
**runtime (2)**: `runtime-ci.yml`, `meta-model-check.yml`
**独立项目 CI (5, 2026-06-06 新建)**: `cockpit-ci.yml`, `agora-ci.yml`, `metaos-ci.yml`, `ecos-ci.yml`, `gbrain-ci.yml`
**跨项目 (1)**: `workspace.yml` (原 `sharedbrain-kairon-integration.yml` 已于 2026-06-09 标记 ARCHIVED — SharedBrain 已归档, kairon 被 .gitignore 排除)
