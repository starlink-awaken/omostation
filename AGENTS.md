...
`make gac-local-gate` includes GaC validation/drift, agent workflow lint/integrations/adapters/bootstrap/doctor/observe, MOF schema/state-bridge/drift checks, documentation SSOT, generated layer digest freshness, link checks, and change-lane checks.
