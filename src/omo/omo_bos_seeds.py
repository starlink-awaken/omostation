"""BOS URI seed registrations — 40 entries covering 5 domains.

Extracted from omo_bos.py to reduce God Module size (1313 → ~600 lines).
...
from .omo_bos import BosRegistration

SEED_REGISTRATIONS: list[BosRegistration] = [
    # ── P33-W1 战役 2 起步: memory × 2 + governance × 4 ──
    BosRegistration(
    ...
    BosRegistration(
        ...
        protocol="internal",
        description="sot-bridge SSOT 注册入口 (P33-W1 战役 2 起步)",
    ),
    BosRegistration(
