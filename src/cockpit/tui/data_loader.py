    ...
    return [
        {
            ...
            "updated_at": "2026-08-02 19:00",
            "summary": "深度研究 Transformer 架构演进路径",
            "asks": [],
        },
        {
            "id": "2",
            "topic": "BOS URI routing design patterns",
            "status": "active",
            "ask_count": 7,
            "created_at": "2026-07-28 09:00",
            "updated_at": "2026-08-01 15:00",
            "summary": "BOS 路由器架构与设计模式研究",
            "asks": [],
        },
        {
            "id": "3",
            "topic": "Textual TUI framework evaluation",
            "status": "active",
            "ask_count": 2,
            "created_at": "2026-08-02 18:00",
            "updated_at": "2026-08-02 19:30",
            "summary": "Textual 框架能力评估与集成方案",
            "asks": [],
        },
        {
            "id": "4",
            "topic": "OMO governance audit patterns",
            "status": "archived",
            "ask_count": 5,
            "created_at": "2026-07-20 14:00",
            "updated_at": "2026-07-30 11:00",
            "summary": "治理审计模式与自动化工作流",
            "asks": [],
        },
        {
            "id": "5",
            "topic": "LLM inference scheduling at edge",
            "status": "active",
            "ask_count": 0,
            "created_at": "2026-08-02 17:00",
            "updated_at": "2026-08-02 17:30",
            "summary": "边缘端 LLM 推理调度与性能优化",
            "asks": [],
        },
    ]
