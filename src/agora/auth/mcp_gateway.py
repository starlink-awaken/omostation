...
KNOWN_BACKENDS: list[dict] = [
    ...
    # ── 入口收敛新增 (2026-06-24) ──────────────────────────
    {
        ...
        "mcp_endpoint": "",
        "command": "uv",
        "args": ["run", "--package", "cockpit", "python", "-m", "cockpit.scripts.cockpit_mcp"],
    ...
    },
    {
        ...
        "mcp_endpoint": "",
        "command": "uv",
        "args": ["run", "--directory", "projects/c2g", "python", "-m", "c2g.mcp_server"],
    ...
    },
    {
        ...
        "mcp_endpoint": "",
        "command": "uv",
        "args": ["run", "--directory", "projects/runtime", "python", "-m", "runtime.mcp_server"],
    ...
    },
    {
        ...
        "mcp_endpoint": "",
        "command": "uv",
        "args": ["run", "--directory", "projects/l4-kernel", "python", "-m", "l4_kernel.mcp_server"],
    ...
    },
    {
        ...
        "mcp_endpoint": "",
        "command": "uv",
        "args": ["run", "--directory", "projects/aetherforge", "python", "-m", "aetherforge.mcp_server"],
    ...
    },
    {
        ...
        "mcp_endpoint": "",
        "command": "uv",
        "args": ["run", "--directory", "projects/model-driven", "python", "-m", "model_driven.mcp_server"],
