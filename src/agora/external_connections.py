...
# god-module 拆解 (2026-08-06): catalog diff 抽到 external_connections_diff.py (1663→1460).
# 循环 import 安全: ExternalConnectionError 已定义 (上方), import diff 时它已可用;
# external_connections_diff 顶层 import ExternalConnectionError 拿到的是已定义的 class.
from agora.external_connections_diff import (  # noqa: E402  (re-export after class def)
